// components/EditHospital.js
import React, { useState, useEffect } from 'react';
import { useParams, useNavigate } from 'react-router-dom';
import { getHospitalById, updateHospital } from '../api/hospitalsApi';
import './hospital.css';
...
const EditHospital = () => {
  ...
  if (isLoading) return <div className="loading">Loading hospital data...</div>;
    ...
    <div className="edit-form-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          {formData.imageUrl && (
            <div className="image-preview">
              <img src={formData.imageUrl} alt="Hospital Preview" />
            </div>
          )}
        </div>
        ...
        <div className="form-actions">
          <button type="submit" className="update-button">Update Hospital</button>
          <button 
            type="button" 
